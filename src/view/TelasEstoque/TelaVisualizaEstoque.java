 ...
 * @author gilberto
 */
public class TelaVisualizaEstoque extends javax.swing.JInternalFrame {

    /**
     * Creates new form TelaPesquisaClientes
     */
    public TelaVisualizaEstoque() {
        initComponents();
    ...
    public void findJtable(){
        ...
        for(Estoque e: edao.find()){
            
            modelo.addRow(new Object[]{
                e.getNome().toUpperCase(),
                formato.format(e.getQtde()),
                e.getUtilizacao().toUpperCase(),
                formato.format(e.getValor_unitario())
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setResizable(true);
        setTitle("Lista de Produtos em Estoque");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nome", "Quantidade", "Banho", "Valor Unitario"
            }
        ) {
