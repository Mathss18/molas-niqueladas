 ...
 * @author gilberto
 */
public class TelaFaturamentoMetalFlex extends javax.swing.JInternalFrame {
     ...
     */
    public TelaFaturamentoMetalFlex() {
        initComponents();
    ...
    public void findFaturamentoPorData(String d1, String d2) {              //PREENCHE TABELA COM OS VALORES
        ...
        for (Faturamento f : fdao.readPorData(d1, d2)) {
    ...
    public void AtualizarValorPeso(String data1, String data2) {
        ...
        Double peso;
        Double aberto;
        Double abertoMaisValor;
        DecimalFormat formatoDec = new DecimalFormat("###,###,##0.00");
        FaturamentoDAO fDAO = new FaturamentoDAO();
        valor = fDAO.readValor(data1, data2);
        peso = fDAO.readPeso(data1, data2);
        aberto = fDAO.readValorAberto(data1, data2);
        abertoMaisValor = aberto+valor;
        lbl_valor.setText(formatoDec.format(abertoMaisValor));
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Faturamento Metal-Flex");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(tbl_cliente, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 320, Short.MAX_VALUE)
    ...
    private void btn_atualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_atualizarActionPerformed
        ...
        if (jTable6.getSelectedRow() == -1) {
            ...
            FaturamentoDAO fDAO = new FaturamentoDAO();
            fDAO.update(ID_faturamento, vale, nfe, situacao, cliente, peso, valor);
            //--------------------------------------------------------------------------
            DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
